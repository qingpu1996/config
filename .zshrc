...
qodercli() { BUN_OPTIONS="--preload=~/.loongsuite-pilot/hooks/qodercli-token-intercept.mjs" command qodercli "$@"; }
# loongsuite-pilot END qodercli-intercept

# loongsuite-pilot BEGIN claude-code-intercept
claude() { BUN_OPTIONS="--preload=~/.loongsuite-pilot/hooks/claude-code-fetch-intercept.mjs ${BUN_OPTIONS}" command claude "$@"; }
